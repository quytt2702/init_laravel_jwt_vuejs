...
/**
 * Class OptimizeRequestCriteria.
 *
 * @package namespace App\Criteria;
 */
class OptimizeRequestCriteria implements CriteriaInterface
{
    /**
    ...
    protected $sortedByDefault;

    /**
     * OptimizeRequestCriteria constructor.
     *
     * @param string $orderBy
     * @param string $sortedBy
     */
    public function __construct(string $orderBy = 'created_at', string $sortedBy = 'desc')
    {
        $this->request         = app(Request::class);
        $this->orderByDefault  = $orderBy;
        $this->sortedByDefault = $sortedBy;
    }
    ...
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        $orderBy          = $this->request->get(
            config('repository.criteria.params.orderBy', 'order_by'),
            $this->orderByDefault
        );
        $sortedBy         = $this->request->get(
            config('repository.criteria.params.sortedBy', 'sorted_by'),
            $this->sortedByDefault
        );
        // Cannot using available
        $with         = null;
        $withCount    = null;
        $searchJoin   = null;
        $searchFields = null;
